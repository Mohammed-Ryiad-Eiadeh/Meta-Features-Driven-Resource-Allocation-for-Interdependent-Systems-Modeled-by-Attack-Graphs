...
public class KatzCentralityMethod {
     ...
     */
    public KatzCentralityMethod(double[][] adjMatrix, double[] lossVector) {
        if (adjMatrix == null) {
    ...
    public HashMap<Integer, Double> getScores() {
        ...
        KatzCentrality<Integer, DefaultWeightedEdge> katzCentrality = new KatzCentrality<>(graph);
        Map<Integer, Double> mapNodeToCentrality = katzCentrality.getScores();
